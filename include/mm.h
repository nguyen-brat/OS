...
#define PAGING_MAX_PGN  16384//(DIV_ROUND_UP(PAGING_CPU_BUS_WIDTH,PAGING_PAGESZ))
...
/* Extract SWAPFPN */
//#define PAGING_OFFST(x)  GETVAL(x,PAGING_OFFST_MASK,PAGING_ADDR_PGN_LOBIT)
/* Extract SWAPTYPE */
//#define PAGING_SWP(x)  GETVAL(x,PAGING_SWP_MASK,PAGING_ADDR_FPN_LOBIT)
